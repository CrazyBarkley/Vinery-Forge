...
public class VineryConfiguredFeatures {
    ...
    public static final Holder<PlacedFeature> TREE_CHERRY = PlacementUtils.register("tree_cherry", CHERRY, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.01f, 1), ObjectRegistry.CHERRY_SAPLING.get()));
    public static final Holder<PlacedFeature> TREE_CHERRY_OLD = PlacementUtils.register("tree_cherry_old", OLD_CHERRY, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.01f, 1), ObjectRegistry.OLD_CHERRY_SAPLING.get()));
